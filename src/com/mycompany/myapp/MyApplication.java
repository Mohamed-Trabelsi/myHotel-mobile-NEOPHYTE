...
import com.mycompany.gui.HomeUserFront;
import com.mycompany.services.ServiceUser;
import com.serv.gui.WalkthruForm;
       ...
       // hi.add(btTest);
        ...
        loginButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                if (u == null ) {
                ...
                } else if (u != null && u.getEtat() == 1 && "Admin".equals(u.getRole()) ) {
                    u.setPassword(tfPassword.getText());
                    tfEmail.setText("");
                    tfPassword.setText("");
                    HomeUserForm Hu = new HomeUserForm(u, hi);//backkkkkk
                    ...
                    tfEmail.setText("");
                    tfPassword.setText("");
                    HomeUserFront Hu = new HomeUserFront(u, hi);
