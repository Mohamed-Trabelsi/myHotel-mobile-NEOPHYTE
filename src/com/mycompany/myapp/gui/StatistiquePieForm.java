...
Form a;
       ...
       btnListSponsors.addActionListener(e-> new AfficherProduit(a).show());
        btnListEvenements.addActionListener(e-> new AfficherFournisseur(a).show());
