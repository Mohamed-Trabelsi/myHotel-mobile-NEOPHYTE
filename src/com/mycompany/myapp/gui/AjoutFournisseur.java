...
Button btnAdd = new Button("Add");
    btnAdd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                {
                    try {
                    Fournisseurs t = new Fournisseurs(tfLibelle.getText(),tfDescription.getText(),Integer.parseInt(tfDateD.getText()));

                        if( ServiceFournisseurs.getInstance().AddFournisseur(t))
                        {
